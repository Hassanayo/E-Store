    ...
    <>
      ...
      {Product.map((product: any) => {
        if (product.id == lastItem) {
          return (
            <ProductPageContainer key={product.id}>
              ...
              <FlexBox flexDirection="column">
                <div>
                  ...
                  <div className="product-details">
                    Find stunning women cocktail and party dresses. Stand out in
                    lace and metallic cocktail dresses and party dresses from
                ...
                >
                  ...
                  <div style={{ paddingBottom: "20px" }}>
                    <AddToCartBig click={() => addToCart(product)} />
                  </div>
                  <FlexBox
                    flexDirection="column"
                    alignItems="flex-end"
