...
import { AddToCartIcon, ClockIcon, Close, CoinsIcon, HeartIcon, PeopleIcon } from '../../assets/vectors';
  ...
  return (
    <ModalContainer >
      <FlexBox flexDirection="column" gap='30px'>
        ...
        <FlexBox>
          <Button width='254px' height='52px' onClick={() => setIsOpen(false)}>OK</Button>
        </FlexBox>
      </FlexBox>
